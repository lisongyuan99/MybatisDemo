...
public final class StudentCourseDynamicSqlSupport {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-25T12:00:17.5406007+08:00", comments="Source Table: student_course")
    public static final StudentCourse studentCourse = new StudentCourse();

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-25T12:00:17.5406007+08:00", comments="Source field: student_course.id")
    public static final SqlColumn<Integer> id = studentCourse.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-25T12:00:17.5406007+08:00", comments="Source field: student_course.student_id")
    public static final SqlColumn<Integer> studentId = studentCourse.studentId;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-10-25T12:00:17.5406007+08:00", comments="Source field: student_course.course_id")
